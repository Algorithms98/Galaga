...
class Game:
  ...
  def initialize(self):
    self.player = Player("Images/pShip.gif", 150, 760)
    ...
    if not self.over:
      ...
      if not self.respawning:
        if playerInput >= 3 and len(self.playerBullets) < self.MAX_PLAYER_BULLETS and not self.over:
          self.playerBullets.append(Projectile("Images/rocket.gif", self.player.getX() + self.player.getWidth()/2, self.player.getY()))
  ...
  def enemyShoot(self, x, y):
    self.enemyBullets.append(EnemyProjectile("Images/alienRocket.gif", x, y, self.player.getX()))
  ...
  def flyInType1(self):
    ...
    for i in range(4):
      self.enemies.append(FlyingEnemy("Images/eShip2.gif", -1000-(180*i), 700, 1, self.player,
          0, 3+i, True))
    

    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip.gif", -1090-(180*i), 700, 1, self.player,
          1+i, 3, False))

    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip.gif", -1270-(180*i), 700, 1, self.player,
          1+i, 6, False))
    

    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip.gif", 487, -200-(60*i), 3, self.player,
          1, i+4, False))
    
    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip.gif", 487, -320-(60*i), 3, self.player,
          2, i+4, False))
    

    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip3.gif", 387, -200-(60*i), 4, self.player,
          3, i+4, False))

    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip3.gif", 387, -320-(60*i), 4, self.player,
          4, i+4, False))
    

    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip.gif", 1000+2300+(60*i), 700, 2, self.player,
          1, i+7, False))
    
    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip.gif", 1000+2420+(60*i), 700, 2, self.player,
          2, i+7, False))
    
    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip.gif", 1000+2540+(60*i), 700, 2, self.player,
          1, i+1, False))
    
    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip.gif", 1000+2660+(60*i), 700, 2, self.player,
          2, i+1, False))
    

    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip3.gif", 387, -3500-200-(60*i), 4, self.player,
          3, i+2, False))
    
    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip3.gif", 387, -3500-320-(60*i), 4, self.player,
          4, i+6, False))
    
    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip3.gif", 387, -3500-420-(60*i), 4, self.player,
          3, i+6, False))

    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip3.gif", 387, -3500-540-(60*i), 4, self.player,
          4, i+2, False))


    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip3.gif", 487, -5000-200-(60*i), 3, self.player,
          3, i, False))

    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip3.gif", 487, -5000-320-(60*i), 3, self.player,
          4, i+8, False))

    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip3.gif", 487, -5000-420-(60*i), 3, self.player,
          3, i+8, False))

    for i in range(2):
      self.enemies.append(FlyingEnemy("Images/eShip3.gif", 487, -5000-540-(60*i), 3, self.player,
          4, i, False))
